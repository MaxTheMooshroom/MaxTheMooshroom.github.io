...
Prior to Splice's development, a team will be working on assets for a tech demo of teh engine. 
These assets will be implemented during the 3rd iteration, and will be used to showcase the 
engine to players and developers alike, hopeing to draw a crowd.

### Description
A basic description of the demo is as follows:
